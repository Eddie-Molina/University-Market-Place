...
public class Search extends AppCompatActivity {
    ...
    public void search(){
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ArrayAdapter<String> initialAdapter = new ArrayAdapter<String>(Search.this, android.R.layout.simple_spinner_item, initial);
                ...
                if(searchCategory.equals("Users")){
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Search.this, android.R.layout.simple_spinner_item, list);
                ...
                if(category.equals("Users")){
                    ...
                    while(groups.moveToNext()){
                        ...
                        if(selected.equals(match)){
                            ...
                            Intent groupIntent = new Intent(Search.this, GroupResults.class);//change GroupActivity to whatever is needed
    ...
    public void cancel(){
        cancelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mainIntent = new Intent(Search.this, Login.class);
